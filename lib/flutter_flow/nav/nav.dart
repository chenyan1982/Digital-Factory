...
class AppStateNotifier extends ChangeNotifier {
  DigitalFactoryFirebaseUser? initialUser;
  DigitalFactoryFirebaseUser? user;
  ...
  void update(DigitalFactoryFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, _) =>
          appStateNotifier.loggedIn || true ? HomePageWidget() : SignInWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          builder: (context, _) => appStateNotifier.loggedIn || true
              ? HomePageWidget()
              : SignInWidget(),
          routes: [
            FFRoute(
            ...
            FFRoute(
              name: 'deviceInfo',
              path: 'deviceInfo',
              builder: (context, params) => DeviceInfoWidget(
